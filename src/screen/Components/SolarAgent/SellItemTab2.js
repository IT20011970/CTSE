...
const SellItemTab2 = () => {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.container}>
            <TouchableOpacity style={styles.defaultButton2} onPress={()=>{naviation.navigate("SellItemTab1")}}>
                        <Text style={{textAlign:'center',fontSize:16,color:'black'}}>View Item</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.defaultButton1}>
                        <Text style={{textAlign:'center',fontSize:16,color:'#fff'}}>Add Item</Text>
            </TouchableOpacity>
           ...
           <View style={{flex:2}}>
            ...
            <View style={styles.formInput}>
                    <TextInput style={styles.textInput} placeholder="Item Name" onChangeText={e => handleChange(e,"item")}/>
                </View>
                <View style={styles.formInput}>

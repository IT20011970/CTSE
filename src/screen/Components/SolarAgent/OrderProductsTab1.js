        ...
        <ScrollView>
            ...
            <View style={{marginTop:40,paddingHorizontal:20,margin:1}}>
                ...
                <View style={{width:width-40,height:200}}>
                    <Image style={{flex:1,height:null,width:null,resizeMode:'contain',borderRadius:5}} source={require('../../../assets/images/solar1.png')}/>
                </View>
            ...
            <View style={{flexDirection:'row',backgroundColor:'white',margin:20,borderRadius:5, borderWidth:2,borderColor:"#a7a7a7"}}>
                 <View style={{margin:5,flex:1}}>
                     <Text style={{fontWeight:'400',margin:10,fontSize:14}}> Quantity</Text>
                </View>
                ...
                <View style={{margin:5}}>
                    <NumericInput totalWidth={40}  totalHeight={40} type='up-down' onChange={value => console.log(value)} />
                </View>
            </View>

...
import { getData, UpdateComplain, DeleteComplain } from "../../../Api/Api";
                    ...
                    return (<>
                        ...
                        <View style={styles.card}>
                            <View style={{ flexDirection: 'row', padding: 5, marginTop: 5, borderRadius: 3, margin: 10 }}>
                                ...
                                <TouchableOpacity style={styles.defaultButton12} onPress={() => { post() }}>
                                    <Text style={{ textAlign: 'center', fontSize: 16, color: '#fff' }} onPress={() => { deleteData(complain.key) }}>Delete</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={{ flexDirection: 'row', padding: 5, marginTop: 5, borderRadius: 3, margin: 10 }}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ flexDirection: 'row', padding: 5, marginTop: 5, borderRadius: 3, margin: 10, justifyContent: 'center' }}>
                                    <TextInput style={styles.textInput} placeholder="Complain" onChangeText={e => handleChange(e, "complain", complain)} secureTextEntry={true} />

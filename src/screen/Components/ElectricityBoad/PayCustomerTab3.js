        ...
        <ScrollView>
         <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row',  padding: 5, marginTop: 5,borderRadius : 3 ,margin:10}}>
                    ...
                    <Text style={styles.HraderStyle}>:12-01-22</Text>
            </View>
            <View style={{ flexDirection: 'row',  padding: 5, marginTop: 5,borderRadius : 3 ,margin:10}}>
                    <Text style={styles.HraderStyle}>Payment</Text>
                    <Text style={styles.HraderStyle}>:LKR 20,000</Text>
            </View>
        </View>
            ...
            <View style={{margin:10, flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity style={styles.defaultButton1}  onPress={()=>{naviation.navigate("PayCustomer4")}}>
                        <Text style={{textAlign:'center',fontSize:16,color:'#fff'}}>Pay Money</Text>
                    </TouchableOpacity>
            </View>
        </ScrollView>
...
export default PayCustomerTab3;

        ...
        <ScrollView>
            <View><View>
                ...
                <View style={styles.card}>
                    <View style={{flexDirection: 'column', padding: 5, marginTop: 5}}>
                        <View style={{alignItems: 'flex-start'}}>
                            ...
                            <Text style={styles.HraderStyle}>3 kW</Text>
                        </View>
                ...
                <View style={styles.card}>
                    <View style={{flexDirection: 'column', padding: 5, marginTop: 5}}>
                        <View style={{alignItems: 'flex-start'}}>
                            <Text style={[styles.HraderStyle, {fontWeight: 'bold', fontSize: 14}]}>Amal</Text>
                            <Text style={styles.HraderStyle}>4 kW</Text>
                        </View>
                        <View style={{alignItems: 'flex-end', marginTop: -30}}>
                            <TouchableOpacity onPress={() => {
                                naviation.navigate("OffgridSolarTab")
                            }}>
                                <Text style={{textAlign: 'center', fontSize: 16, color: 'black'}}><Icon name="login"
                                                                                                        size={30}
                                                                                                        color="black"/></Text>
                ...
                <View style={styles.card}>
                    <View style={{flexDirection: 'column', padding: 5, marginTop: 5}}>
                        <View style={{alignItems: 'flex-start'}}>
                            ...
                            <Text style={styles.HraderStyle}>5 kW</Text>
                        </View>
                        <View style={{alignItems: 'flex-end', marginTop: -30}}>
                            <TouchableOpacity onPress={() => {
                                naviation.navigate("OffgridSolarTab")

                ...
                <View style={styles.card}>
                    <View style={{flexDirection: 'column', padding: 5, marginTop: 5}}>
                        <View style={{alignItems: 'flex-start'}}>
                            <Text style={[styles.HraderStyle, {fontWeight: 'bold', fontSize: 14}]}>{complain.userEntity.name}</Text>
                            <Text style={styles.HraderStyle}>3 kW</Text>
                        </View>
                        <View style={{alignItems: 'flex-end', marginTop: -30}}>
                        <TouchableOpacity onPress={() => {
                                naviation.navigate("OngridSolarTab2")
                            }}>

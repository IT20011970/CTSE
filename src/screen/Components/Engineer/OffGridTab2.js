        ...
        <ScrollView>
            ...
            <View style={styles.card}>
                ...
                <View style={{flexDirection: 'row', padding: 5, marginTop: 5, borderRadius: 3, margin: 10}}>
                    ...
                    <Text style={[styles.HraderStyle, {fontWeight: 'bold'}]}>: 70%</Text>
                </View>
                <View style={{flexDirection: 'row', padding: 5, marginTop: 5, borderRadius: 3, margin: 10}}>
                    <Text style={styles.HraderStyle}>Battery Status</Text>
                    <Text style={[styles.HraderStyle, {fontWeight: 'bold'}]}>: On</Text>
                </View>
                <View style={{flexDirection: 'row', padding: 5, marginTop: 5, borderRadius: 3, margin: 10}}>
                    <Text style={styles.HraderStyle}>Battery Health</Text>
                    <Text style={[styles.HraderStyle, {fontWeight: 'bold'}]}>: Good</Text>
                </View>
            </View>
            ...
            <View style={{margin: 10, flexDirection: 'row'}}>
                <TouchableOpacity style={styles.defaultButton1} onPress={() => {
                    naviation.navigate("OffgridSolar")
                }}>

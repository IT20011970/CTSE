    ...
    return (<ScrollView>
            ...
            <View style={{
                ...
                <View>
                    <View style={{flexDirection: 'row'}}>
                        <Text style={[styles.HraderStyle, {fontWeight: 'bold'}]}>Current Bill : </Text>
                        <Text style={[styles.HraderStyle, {fontWeight: 'bold'}]}>LKR 6000</Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                        <Text style={[styles.HraderStyle, {fontWeight: 'bold'}]}>Expected Bill : </Text>
            ...
            <View style={{margin: 10, flexDirection: 'row'}}>
                <TouchableOpacity style={[styles.defaultButton1, {marginRight: 5}]} onPress={() => {
                    naviation.navigate("CustomerReq")
                }}>
                ...
                <TouchableOpacity style={[styles.defaultButton1, {marginLeft: 5}]} onPress={() => {
                    naviation.navigate("CustomerReq3")
                }}>
...
export default CustomerReqTab2;

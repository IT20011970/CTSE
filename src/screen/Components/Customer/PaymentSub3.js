    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row',  padding: 5, marginTop: 5,backgroundColor:'#F8F8F8', borderRadius : 3 ,margin:10}}>
                    <Text style={styles.HraderStyle}>12-10-22</Text>
                    <Text style={styles.HraderStyle}>Meter Cost</Text>
                    <Text style={styles.HraderStyle}>LKR 1000</Text>
            </View>
            <View style={{ flexDirection: 'row',  padding: 5, marginTop: 5,backgroundColor:'#F8F8F8', borderRadius : 3 ,margin:10}}>
                    <Text style={styles.HraderStyle}>12-10-22</Text>
                    <Text style={styles.HraderStyle}>Light Bill</Text>
                    <Text style={styles.HraderStyle}>LKR 2000</Text>
            </View>
        </View>
